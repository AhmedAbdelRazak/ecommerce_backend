...
exports.userById = async (req, res, next, id) => {
    ...
    try {
        const user = await User.findById(id)
            .select("_id name email role user points activePoints likesUser activeUser employeeImage userRole history userStore userBranch")
            // Uncomment and adjust the populate method as needed
            // .populate("likesUser", "_id productName description ratings views viewsCount")
            .exec();
